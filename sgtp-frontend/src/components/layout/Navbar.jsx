...
export default function Navbar() {
    ...
    return (
        <header className="border-b border-emerald-950/5 rounded-tl-lg rounded-tr-lg flex items-center justify-end px-5 py-2.5"> 
            <div className="relative flex items-center gap-2.5" ref={menuRef}>
                ...
                >
                    ...
                    <div className="text-left hidden sm:block">
                        ...
                        <p className="text-xs text-neutral-500 leading-tight">Administrador</p>
                    </div>
                ...
                {menuAberto && (
                    <div className="absolute right-0 mt-2 w-48 bg-white border border-neutral-300 rounded-xl shadow-lg py-1.5 z-20">
                        <div className="px-3 py-2 border-b border-neutral-300 sm:hidden">
                            <p className="text-sm font-medium text-green-950">{usuario?.nome}</p>
